...
assert(args.train + args.test == 0.9)
...
if args.sample_file == '' and args.sample_folder == '':
    ...
    create_splits(args.sample_file, args.num_splits, args.train, args.test, args.output_folder)
elif args.sample_folder != '':
    sample_files = [f for f in os.listdir(args.sample_folder) if f.endswith('txt')]
    print(sample_files)

    for s in sample_files:
        create_splits(os.path.join(args.sample_folder, s), args.num_splits, 
            args.train, args.test, args.output_folder)
